...
@interface TimeCircuitsViewController ()
{
    ...
    NSTimer *timerSpeedometer;
    NSDateFormatter *dateFormatTimeCircuit;
    NSInteger speedDeLorean;
}
...
- (void)viewDidLoad
{
    ...
    //
    dateFormatTimeCircuit = [[NSDateFormatter alloc] init];
    //
    ...
    [dateFormatTimeCircuit setDateFormat:formatString];
    ...
    //
    self.presentTimeLabel.text = [dateFormatTimeCircuit stringFromDate:[NSDate date]];
    ...
    //
    self.speedLabel.text = [NSString stringWithFormat:@"%ld MPH",(long)speedDeLorean];
...
- (void)startTimer
{
    ...
    if (!timerSpeedometer)
    {
       ...
       timerSpeedometer = [NSTimer scheduledTimerWithTimeInterval:0.1
                                                           target:self
...
- (void)stopTimer
{
    ...
    //    again.
    //
    [timerSpeedometer invalidate];
    timerSpeedometer = nil;
